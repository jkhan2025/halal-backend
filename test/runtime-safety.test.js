...
test('npm checks only select isolated tests, not environment loading or the server', () => {
  ...
  assert.equal(manifest.scripts.test, 'node --test test/runtime-safety.test.js test/grocery-result-contract.test.js test/trust-foundation.test.js test/restaurant-result-contract-foundation.test.js');
});
